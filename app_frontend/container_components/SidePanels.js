...
const SidePanelContainer = ({ isVisible, side, title, children }) => {
    ...
    <Animated.View style={[styles.sidePanel, side === 'left' ? styles.leftPanel : styles.rightPanel, panelPosition]}>
        <View style={styles.sidePanelContentContainerStyle}>
            <Text style={styles.sidePanelTitleStyle}>{title}</Text>
            {children}
        </View>
    </Animated.View>
    ) : null;
...
const LeftSidePanel = (props) => {
    ...
    return (
    <SidePanelContainer id="left-panel" side="left" title="Left Panel" {...props}>
...
const RightSidePanel = (props) => {
    ...
    return (
        <SidePanelContainer id="right-panel" side="right" title="Right Panel" {...props}>
